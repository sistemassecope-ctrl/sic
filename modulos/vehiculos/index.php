...
if ($f_region) { $where[] = "v.region = ?"; $params[] = $f_region; }
if ($f_logotipos && $f_logotipos != 'Todos') { $where[] = "v.con_logotipos = ?"; $params[] = $f_logotipos; }
if ($f_baja && $f_baja != 'Todos') { $where[] = "v.en_proceso_baja = ?"; $params[] = $f_baja; }
if ($f_color && $f_color != 'Todos') { $where[] = "v.color = ?"; $params[] = $f_color; }
if ($f_marca && $f_marca != 'Todas') { $where[] = "v.marca = ?"; $params[] = $f_marca; }
if ($f_modelo && $f_modelo != 'Todos') { $where[] = "v.modelo = ?"; $params[] = $f_modelo; }
if ($f_tipo && $f_tipo != 'Todos') { $where[] = "v.tipo = ?"; $params[] = $f_tipo; }
if ($f_resguardo) { $where[] = "v.resguardo_nombre LIKE ?"; $params[] = "%$f_resguardo%"; }
if ($f_area_nombre) { $where[] = "a.nombre_area LIKE ?"; $params[] = "%$f_area_nombre%"; }
...
<main class="main-content">
    <div class="page-header">
        ...
        <div>
             <?php if (hasPermission('crear', $MODULO_ID)): ?>
                ...
                <form method="GET" id="searchForm">
                    ...
                    <div class="row g-2 align-items-end">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="resguardo" class="form-control form-control-sm" placeholder="Nombre..." value="<?= e($f_resguardo) ?>">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label small fw-bold mb-1">Secretaria / Depto</label>
                            <input type="text" name="area_nombre" class="form-control form-control-sm" placeholder="Buscar área..." value="<?= e($f_area_nombre) ?>">
                        </div>
                    </div>
                ...
                <tbody>
                    ...
                    <?php else: ?>
                        ...
                        <tr>
                            ...
                            <td><?= e($v['region']) ?></td>
                            <td>
                                <div class="text-truncate" style="max-width: 200px;" title="<?= e($v['resguardo_nombre']) ?>">
                            ...
                            <td class="text-end pe-3">
                                ...
                                <div class="btn-group">
                                    ...
                                    <!-- Eliminar Trigger -->
                                    <button type="button" class="btn btn-sm btn-outline-danger" title="Eliminar Permanentemente"
...
function confirmarBaja(id, economico) {
    ...
    if (bajaModal) {
        ...
        // Fallback if bootstrap JS issues
        alert("Bootstrap Modal no cargó correctamente. Implementar fallback si es necesario.");
    }
}
