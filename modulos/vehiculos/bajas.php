...
// ID del módulo de Histórico de Bajas
define('MODULO_ID', 46);
...
if (!$puedeVer) {
    setFlashMessage('error', 'No tienes permiso para acceder al histórico de bajas.');
    redirect('/index.php');
}
                    ...
                    <?php else: ?>
                        <?php foreach ($bajas as $index => $v): ?>
                            <tr>
                                ...
                                <td>
                                    <div class="fw-bold text-dark">ECO-
                                        <?= e($v['numero_economico']) ?>
                                    </div>
                                ...
                                <td>
                                    ...
                                    <div class="small text-muted">Año:
                                        <?= e($v['anio_baja']) ?>
                                    </div>
                                </td>
                                <td>
    ...
    <div class="modal-dialog modal-lg modal-dialog-scrollable">
        <div class="modal-content bg-dark text-white border-secondary">
            <div class="modal-header bg-dark text-white border-secondary">
                <h5 class="modal-title"><i class="fas fa-history"></i> Bitácora: <span id="modalNotasTitulo"></span>
                </h5>
