...
<body class="bg-light min-vh-100 d-flex flex-column align-items-center justify-content-start">
    <div class="text-center my-4">
        <a href="index.php"><img src="<?php echo BASE_URL; ?>/img/logo_secope.png" alt="Logo SECOPE"
    ...
    <div class="container bg-white rounded-4 shadow p-4 mb-4" style="max-width:800px;">
        ...
        <?php if ($existe_persona && !$modo_edicion && $persona): ?>
            ...
            <div class="row">
                <div class="col-md-6">
                    <h4 class="text-primary">
                        <?php echo ($tipo_persona === 'moral') ? 'Información de la Empresa' : 'Información Personal'; ?>
                    </h4>
                    <p><strong><?php echo ($tipo_persona === 'moral') ? 'Razón Social' : 'Nombre'; ?>:</strong>
                        <?php echo htmlspecialchars(getValue($persona, ($tipo_persona === 'moral' ? 'nombre_empresa' : 'nombre'))); ?>
                    </p>
                    <p><strong>RFC:</strong> <?php echo htmlspecialchars(getValue($persona, 'rfc')); ?></p>
                    <p><strong>Especialidad:</strong> <?php echo htmlspecialchars(getValue($persona, 'especialidad')); ?>
                    </p>
                    ...
                    <?php else: ?>
                        <p><strong>Identificación:</strong>
                            <?php echo htmlspecialchars(getValue($persona, 'documento') . ' ' . getValue($persona, 'numero_documento')); ?>
                        </p>
                    <?php endif; ?>
                </div>
                <div class="col-md-6">
                    ...
                    <p><strong>Dirección:</strong>
                        <?php echo htmlspecialchars(getValue($persona, 'calle') . ', ' . getValue($persona, 'colonia') . ', ' . getValue($persona, 'municipio') . ', ' . getValue($persona, 'estado') . ' CP: ' . getValue($persona, 'cp')); ?>
                    </p>
                    ...
                    <?php if ($tipo_persona === 'moral'): ?>
                        ...
                        <p><strong>Escritura Poder:</strong>
                            <?php echo htmlspecialchars(getValue($persona, 'rep_escritura')); ?></p>
                    <?php endif; ?>
                </div>
            </div>
                ...
                <div class="row mt-3">
                    <div class="col-md-12">
                        ...
                        <p class="text-muted border-bottom pb-2">
                            <?php echo nl2br(htmlspecialchars(getValue($persona, 'descripcion'))); ?></p>
                    </div>
                </div>
            <?php endif; ?>
                            ...
                            if ($resultado_cert->num_rows > 0) {
                                ...
                                if ($certificado_data['papeleria_correcta'] && $certificado_data['vigente']) {
                                    ...
                                    if ($hoy <= $fecha_vigencia) {
                                        ...
                                        $fecha_fmt = strftime('%d de %B de %Y', strtotime($fecha_vigencia));
                                        // Fallback manual si strftime falla o no está en español
                                        $meses = ['January' => 'Enero', 'February' => 'Febrero', 'March' => 'Marzo', 'April' => 'Abril', 'May' => 'Mayo', 'June' => 'Junio', 'July' => 'Julio', 'August' => 'Agosto', 'September' => 'Septiembre', 'October' => 'Octubre', 'November' => 'Noviembre', 'December' => 'Diciembre'];
                                        $mes_nombre = $meses[date('F', strtotime($fecha_vigencia))];
                                        $fecha_texto = date('d', strtotime($fecha_vigencia)) . ' de ' . $mes_nombre . ' de ' . date('Y', strtotime($fecha_vigencia));

                                        $mensaje_certificado = '<div class="alert alert-success"><strong>✓ Certificado Disponible</strong><br>Número: ' . htmlspecialchars($certificado_data['numero_certificado']) . '<br>Vigente hasta: ' . $fecha_texto . '</div>';
                                    } else {
                                        $meses = ['January' => 'Enero', 'February' => 'Febrero', 'March' => 'Marzo', 'April' => 'Abril', 'May' => 'Mayo', 'June' => 'Junio', 'July' => 'Julio', 'August' => 'Agosto', 'September' => 'Septiembre', 'October' => 'Octubre', 'November' => 'Noviembre', 'December' => 'Diciembre'];
                                        $mes_nombre = $meses[date('F', strtotime($fecha_vigencia))];
                                        $fecha_texto = date('d', strtotime($fecha_vigencia)) . ' de ' . $mes_nombre . ' de ' . date('Y', strtotime($fecha_vigencia));

                                        $mensaje_certificado = '<div class="alert alert-warning"><strong>⚠ Certificado Vencido</strong><br>Número: ' . htmlspecialchars($certificado_data['numero_certificado']) . '<br>Expiró el: ' . $fecha_texto . '</div>';
                                    }
                                } else {
            ...
            <div class="mt-3 d-flex justify-content-between">
                <div>
                    ...
                    <a href="generar_hoja_registro.php" class="btn btn-success ms-2" target="_blank">Descargar Hoja de
                        Registro</a>
                    <a href="documentacion.php" class="btn btn-info text-white ms-2"><i class="fas fa-upload me-1"></i>
        ...
        <?php else: ?>
            ...
            <h4 class="text-primary mb-3">
                <?php echo $modo_edicion ? 'Editar información personal' : 'Complete su información personal'; ?></h4>
            <form method="POST" action="">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            <label for="nombre"
                                class="form-label"><?php echo ($tipo_persona === 'moral' ? 'Nombre o Razón Social *' : 'Nombre completo *'); ?></label>
                            <input type="text" class="form-control" id="nombre"
                                name="<?php echo ($tipo_persona === 'moral' ? 'nombre_empresa' : 'nombre'); ?>"
                                value="<?php echo htmlspecialchars(getValue($persona, ($tipo_persona === 'moral' ? 'nombre_empresa' : 'nombre'))); ?>"
                                required>
                        </div>
                        <div class="mb-3">
                            <label for="especialidad" class="form-label">Especialidad</label>
                            <input type="text" class="form-control" id="especialidad" name="especialidad"
                                value="<?php echo htmlspecialchars(getValue($persona, 'especialidad')); ?>">
                        </div>
                        ...
                        <?php if ($tipo_persona === 'fisica'): ?>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="numero_documento" name="numero_documento"
                                    value="<?php echo htmlspecialchars(getValue($persona, 'numero_documento')); ?>">
                            </div>
                        <?php endif; ?>
                    </div>
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="tel" class="form-control" id="telefono" name="telefono" maxlength="10"
                                value="<?php echo htmlspecialchars(getValue($persona, 'telefono')); ?>" required>
                        </div>
                        <div class="mb-3">
                            <label for="celular" class="form-label">Celular *</label>
                            <input type="tel" class="form-control" id="celular" name="celular" maxlength="10"
                                value="<?php echo htmlspecialchars(getValue($persona, 'celular')); ?>" required>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 border-end">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="acta_escritura"
                                    value="<?php echo htmlspecialchars(getValue($persona, 'acta_escritura')); ?>">
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Fecha</label>
                                <input type="date" class="form-control" name="acta_fecha"
                                    value="<?php echo htmlspecialchars(getValue($persona, 'acta_fecha')); ?>">
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Notario (Nombre, No. y Lugar)</label>
                                <textarea class="form-control" name="acta_notario"
                                    rows="2"><?php echo htmlspecialchars(getValue($persona, 'acta_notario')); ?></textarea>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <input type="text" class="form-control form-control-sm" name="reformas_escritura"
                                        value="<?php echo htmlspecialchars(getValue($persona, 'reformas_escritura')); ?>">
                                </div>
                                <div class="col-6">
                                    <label class="small">Fecha</label>
                                    <input type="date" class="form-control form-control-sm" name="reformas_fecha"
                                        value="<?php echo htmlspecialchars(getValue($persona, 'reformas_fecha')); ?>">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="rep_nombre"
                                    value="<?php echo htmlspecialchars(getValue($persona, 'rep_nombre')); ?>">
                            </div>
                            <div class="row">
                                <div class="col-6">
                                    <label class="small">Escritura Pública No.</label>
                                    <input type="text" class="form-control form-control-sm" name="rep_escritura"
                                        value="<?php echo htmlspecialchars(getValue($persona, 'rep_escritura')); ?>">
                                </div>
                                <div class="col-6">
                                    <label class="small">Fecha Poder</label>
                                    <input type="date" class="form-control form-control-sm" name="rep_fecha"
                                        value="<?php echo htmlspecialchars(getValue($persona, 'rep_fecha')); ?>">
                                </div>
                            </div>
                            <div class="mt-3">
                                <label class="form-label">Notario del Poder (Nombre, No. y Lugar)</label>
                                <textarea class="form-control" name="rep_notario"
                                    rows="2"><?php echo htmlspecialchars(getValue($persona, 'rep_notario')); ?></textarea>
                            </div>
                        </div>
                    </div>
                <?php endif; ?>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="cp" name="cp" maxlength="5"
                                        value="<?php echo htmlspecialchars(getValue($persona, 'cp')); ?>" required>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="calle" name="calle"
                                        value="<?php echo htmlspecialchars(getValue($persona, 'calle')); ?>" required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="estado" name="estado"
                                        value="<?php echo htmlspecialchars(getValue($persona, 'estado')); ?>" readonly
                                        required>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="municipio" name="municipio"
                                        value="<?php echo htmlspecialchars(getValue($persona, 'municipio')); ?>" readonly
                                        required>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <select class="form-control" id="colonia" name="colonia" required>
                                        <?php if ($existe_persona): ?>
                                            <option value="<?php echo htmlspecialchars(getValue($persona, 'colonia')); ?>"
                                                selected><?php echo htmlspecialchars(getValue($persona, 'colonia')); ?></option>
                                        <?php else: ?>
                                            <option value="">Selecciona una colonia</option>
                                        <?php endif; ?>
                                    </select>
                                    <input type="hidden" id="colonia-actual"
                                        value="<?php echo htmlspecialchars(getValue($persona, 'colonia')); ?>">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="imss" name="imss"
                                            value="<?php echo htmlspecialchars(getValue($persona, 'imss')); ?>">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="infonavit" name="infonavit"
                                            value="<?php echo htmlspecialchars(getValue($persona, 'infonavit')); ?>">
                                    </div>
                                </div>
                            <?php endif; ?>
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control text-end" id="capital" name="capital"
                                            placeholder="0.00"
                                            value="<?php echo number_format((float) getValue($persona, 'capital'), 2, '.', ','); ?>">
                                    </div>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="regCmic"
                                        name="<?php echo ($tipo_persona === 'moral' ? 'reg_cmic' : 'regCmic'); ?>"
                                        value="<?php echo htmlspecialchars(getValue($persona, ($tipo_persona === 'moral' ? 'reg_cmic' : 'regCmic'))); ?>">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="mb-3">
                    <label for="descripcion"
                        class="form-label"><?php echo ($tipo_persona === 'moral' ? 'Descripción del Objeto Social' : 'Descripción general'); ?></label>
                    <textarea class="form-control" id="descripcion" name="descripcion"
                        rows="4"><?php echo htmlspecialchars(getValue($persona, 'descripcion')); ?></textarea>
                </div>
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <?php endif; ?>
                        <?php if ($existe_persona): ?>
                            <a href="generar_hoja_registro.php" class="btn btn-success ms-2" target="_blank">Hoja de
                                Registro</a>
