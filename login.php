...
<head>
    ...
    <meta name="description" content="PAO v2 - Sistema de Permisos Atómicos para Organizaciones">
    ...
    <div class="login-container">
        <div class="login-card fade-in">
            <div class="login-header">
                ...
                <p class="login-subtitle">Sistema de Permisos Atómicos para Organizaciones</p>
            </div>
