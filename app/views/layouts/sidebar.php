<div class="sidebar collapse d-md-block" id="sidebarMenu">
    <div class="sidebar-header">
        <img src="/pao/img/logo_secope.png" alt="SIS-PAO" class="img-fluid">
        <h5 class="mt-2 text-white">SIS-PAO</h5>
    </div>
    <ul class="nav flex-column sidebar-menu">
        <li class="nav-item">
            <a class="nav-link <?php echo ($route == 'home') ? 'active' : ''; ?>" href="/pao/index.php?route=home">
